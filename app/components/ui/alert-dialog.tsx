...
import { cn } from '../ui/utils'; // ✅ 프로젝트 경로에 맞춰 조정 필요
import { buttonVariants } from './button'; // ✅ button.tsx에 buttonVariants가 있어야 합니다
...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-[50%] top-[50%] z-[60] w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border border-slate-200 bg-white p-6 text-slate-950 shadow-xl',
        className,
      )}
      {...props}
    />
